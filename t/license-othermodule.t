...
sub test_build {
    ...
    unless ($ini) {
        $ini = simple_ini('GatherDir', 'MetaJSON', 'License', [ 'LicenseFromModule', {source_module => 'lib/DZT/Other.pm',},]);
...
my $ini = simple_ini('GatherDir', 'MetaJSON', 'License', [ 'LicenseFromModule', { override_author => 1, source_module => 'lib/DZT/Other.pm' } ]);
